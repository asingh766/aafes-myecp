...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF042757);
  late Color secondary = const Color(0xFFC4D6EB);
  late Color tertiary = const Color(0xFF000F73);
  late Color alternate = const Color(0xFFE0E3E7);
  late Color primaryText = const Color(0xFF14181B);
  late Color secondaryText = const Color(0xFF505050);
  late Color primaryBackground = const Color(0xFFFFFFFF);
  late Color secondaryBackground = const Color(0xFFE7E7E7);
  late Color accent1 = const Color(0xFF8B929C);
  late Color accent2 = const Color(0xFFCCCCCD);
  late Color accent3 = const Color(0xFF848484);
  late Color accent4 = const Color(0xFFF1F4F8);
  late Color success = const Color(0xFF318B29);
  late Color warning = const Color(0xFFF9CF58);
  late Color error = const Color(0xFFB70100);
