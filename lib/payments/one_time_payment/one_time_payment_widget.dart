...
import '/payments/confirm_delete_alert_box/confirm_delete_alert_box_widget.dart';
...
import 'one_time_payment_model.dart';
export 'one_time_payment_model.dart';

class OneTimePaymentWidget extends StatefulWidget {
  const OneTimePaymentWidget({super.key});

  @override
  State<OneTimePaymentWidget> createState() => _OneTimePaymentWidgetState();
}

class _OneTimePaymentWidgetState extends State<OneTimePaymentWidget> {
  late OneTimePaymentModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => OneTimePaymentModel());
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      if ((_model.getpaymentAccountList?.succeeded ?? true)) {
        ...
        if (!FFAppState().selectedAccountForPayment.isAccountBlocked) {
          setState(() {
            _model.bankingProfileOptions = functions
                .returnBankingProfileOptions(FFAppState()
                    .selectedAccountForPayment
                    .bankProfiles
                    .toList())
                .toList()
                .cast<OptionIntStruct>();
          });
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      onChange:
                                                                        ...
                                                                        if (!FFAppState()
                                                                          ...
                                                                          setState(
                                                                              () {
                                                                            _model.bankingProfileOptions =
                                                                                functions.returnBankingProfileOptions(FFAppState().selectedAccountForPayment.bankProfiles.toList()).toList().cast<OptionIntStruct>();
                                                                          });
                                                                                ...
                                                                                children: [
                                                                                  ...
                                                                                  Row(
                                                                                    ...
                                                                                    children: [
                                                                                      ...
                                                                                      Text(
                                                                                        (_model.payments.isNotEmpty) && (_model.payments.where((e) => e.paymentFrequencyCode == 'M').toList().isNotEmpty) ? 'ON' : 'OFF',
                                                                                        style: FlutterFlowTheme.of(context).bodyMedium.override(
                                                                                              fontFamily: 'Arial',
                                                                                              letterSpacing: 0.0,
                                                                                ...
                                                                                builder: (context) {
                                                                                  if ((_model.payments.isNotEmpty) && (_model.payments.where((e) => e.paymentFrequencyCode == 'O').toList().isNotEmpty)) {
                                                                                      ...
                                                                                      builder: (context) => wrapWithModel(
                                                                                        ...
                                                                                        child: ScheduledPaymentWidget(
                                                                                          ...
                                                                                          onDelete: () async {
                                                                                                  ...
                                                                                                  child: WebViewAware(
                                                                                                    child: GestureDetector(
                                                                                                      ...
                                                                                                      child: SizedBox(
                                                                                                        ...
                                                                                                        width: MediaQuery.sizeOf(context).width * 1.0,
                                                                                                        child: ConfirmDeleteAlertBoxWidget(
                                                                                                          onConfirm: () async {
                                                                                                            Navigator.pop(context);
                                                                                                          },
                                                                                                        ),
                                                                                            ...
                                                                                            _model.deletePaymentResult = await PaymentsGroup.deletePaymentCall.call(
                                                                                              userId: FFAppState().selectedUserId.toString(),
                                                                                              accountNo: FFAppState().selectedAccountForPayment.accountNumber,
                                                                                              paymentNo: _model.payments.where((e) => e.paymentFrequencyCode == 'O').toList().first.paymentNo.toString(),
                                                                                              dynamicBaseURL: FFAppState().dynamicBaseURL,
                                                                                            );
                                                                                            if ((_model.deletePaymentResult?.succeeded ?? true)) {
                                                                                              _model.deleteRefreshAccountPaymentResults = await PaymentsGroup.getPaymentsCall.call(
                                                                                                accountNo: FFAppState().selectedAccountForPayment.accountNumber,
                                                                                                userId: FFAppState().selectedUserId.toString(),
                                                                                                dynamicBaseURL: FFAppState().dynamicBaseURL,
                                                                                              );
                                                                                              if ((_model.deleteRefreshAccountPaymentResults?.succeeded ?? true)) {
                                                                                                setState(() {
                                                                                                  _model.payments = functions.paymentJsonNullRemover((_model.newAccountPaymentResults?.jsonBody ?? '')).map((e) => PaymentStruct.maybeFromMap(e)).withoutNulls.toList().cast<PaymentStruct>();
                                                                                                });
                                                                                              } else {
                                                                                    ...
                                                                                    return wrapWithModel(
                                                                                      model: _model.paymentFormModel,
                                                                                      updateCallback: () => setState(() {}),
                                                                                      child: PaymentFormWidget(
                                                                                        isAutoPayment: false,
                                                                                        profileOptions: _model.bankingProfileOptions,
                                                                                      ),
                                                                                    );
                                                                                  }
                                                                                },
