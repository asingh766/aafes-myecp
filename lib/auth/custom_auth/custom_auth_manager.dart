...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    myECPAuthUserSubject.add(
      MyECPAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<MyECPAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  MyECPAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = MyECPAuthUser(
      loggedIn: true,
      uid: authUid,
      userData: userData,
    );
    myECPAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
