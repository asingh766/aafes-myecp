...
import 'custom_outlined_text_field_email_model.dart';
export 'custom_outlined_text_field_email_model.dart';

class CustomOutlinedTextFieldEmailWidget extends StatefulWidget {
  const CustomOutlinedTextFieldEmailWidget({
    super.key,
  ...
  @override
  State<CustomOutlinedTextFieldEmailWidget> createState() =>
      _CustomOutlinedTextFieldEmailWidgetState();
}

class _CustomOutlinedTextFieldEmailWidgetState
    extends State<CustomOutlinedTextFieldEmailWidget> {
  late CustomOutlinedTextFieldEmailModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CustomOutlinedTextFieldEmailModel());
    ...
    _model.emailTextFieldFocusNode!.addListener(
      () async {
        setState(() {
          _model.hasFocus = (_model.emailTextFieldFocusNode?.hasFocus ?? false);
        });
        if (_model.hasFocus) {
