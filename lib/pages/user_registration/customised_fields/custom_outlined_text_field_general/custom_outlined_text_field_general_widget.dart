...
import 'custom_outlined_text_field_general_model.dart';
export 'custom_outlined_text_field_general_model.dart';

class CustomOutlinedTextFieldGeneralWidget extends StatefulWidget {
  const CustomOutlinedTextFieldGeneralWidget({
    super.key,
    ...
    bool? isUseFull,
        ...
        defaultFocus = defaultFocus ?? true,
        isUseFull = isUseFull ?? false;
  ...
  @override
  State<CustomOutlinedTextFieldGeneralWidget> createState() =>
      _CustomOutlinedTextFieldGeneralWidgetState();
}

class _CustomOutlinedTextFieldGeneralWidgetState
    extends State<CustomOutlinedTextFieldGeneralWidget> {
  late CustomOutlinedTextFieldGeneralModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CustomOutlinedTextFieldGeneralModel());
              ...
              Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    if (widget.isUseFull
                        ? (widget.isUseFull && widget.hasError ? true : false)
                        : true)
                      Builder(
                        builder: (context) {
                          if (widget.hasError) {
