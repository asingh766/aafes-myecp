...
import 'custom_outlined_text_field_card_number_model.dart';
export 'custom_outlined_text_field_card_number_model.dart';

class CustomOutlinedTextFieldCardNumberWidget extends StatefulWidget {
  const CustomOutlinedTextFieldCardNumberWidget({
    super.key,
  ...
  @override
  State<CustomOutlinedTextFieldCardNumberWidget> createState() =>
      _CustomOutlinedTextFieldCardNumberWidgetState();
}

class _CustomOutlinedTextFieldCardNumberWidgetState
    extends State<CustomOutlinedTextFieldCardNumberWidget> {
  late CustomOutlinedTextFieldCardNumberModel _model;
