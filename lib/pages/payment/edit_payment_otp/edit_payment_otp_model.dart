...
import 'edit_payment_otp_widget.dart' show EditPaymentOtpWidget;
import 'package:flutter/material.dart';

class EditPaymentOtpModel extends FlutterFlowModel<EditPaymentOtpWidget> {
  ...
  // Stores action output result for [Backend Call - API (Get Bank Accounts and Bank Profiles by User ID)] action in edit_payment_otp widget.
  ApiCallResponse? apiResponseBanksAndBankProfiles;
  // Stores action output result for [Backend Call - API (Account Summary By Account Number)] action in edit_payment_otp widget.
  ...
  // Stores action output result for [Backend Call - API (Update Payment)] action in CommonCustomButton widget.
  ApiCallResponse? apiResultUpdateResponse;
