...
import 'edit_auto_pay_model.dart';
export 'edit_auto_pay_model.dart';

class EditAutoPayWidget extends StatefulWidget {
  const EditAutoPayWidget({super.key});

  @override
  State<EditAutoPayWidget> createState() => _EditAutoPayWidgetState();
}

class _EditAutoPayWidgetState extends State<EditAutoPayWidget> {
  late EditAutoPayModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditAutoPayModel());
                                                                      ...
                                                                      children: [
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            children: [
                                                                              FlutterFlowRadioButton(
                                                                                options: functions
                                                                                    .returnPaymentMethodOptions(getJsonField(
                                                                                      FFAppState().selectedPaymentAccount,
                                                                                      r'''$["BankProfiles"]''',
                                                                                      true,
                                                                                    )!)
                                                                        ...
                                                                        Container(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            children: [
                                                                              Padding(
                                                                                padding: const EdgeInsetsDirectional.fromSTEB(5.0, 20.0, 10.0, 20.0),
                                                                                child: Wrap(
                                                                                  spacing: 0.0,
                                                                                  runSpacing: 0.0,
