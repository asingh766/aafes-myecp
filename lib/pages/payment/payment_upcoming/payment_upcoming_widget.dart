...
import 'payment_upcoming_model.dart';
export 'payment_upcoming_model.dart';

class PaymentUpcomingWidget extends StatefulWidget {
  const PaymentUpcomingWidget({
    super.key,
    required this.apiResposeAddPayments,
  });

  final dynamic apiResposeAddPayments;

  @override
  State<PaymentUpcomingWidget> createState() => _PaymentUpcomingWidgetState();
}

class _PaymentUpcomingWidgetState extends State<PaymentUpcomingWidget> {
  late PaymentUpcomingModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PaymentUpcomingModel());
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      setState(() {
        _model.bankAccountsAndBankProfileJSON =
            widget.apiResposeAddPayments!.toList().cast<dynamic>();
      });
    });
                                                ...
                                                child: Padding(
                                                  padding: const EdgeInsetsDirectional
                                                      .fromSTEB(
                                                          10.0, 20.0, 0.0, 0.0),
                                                  child: Text(
                                                    'A confirmation email has been sent to ${getJsonField(
                                                      widget
                                                          .apiResposeAddPayments,
                                                      r'''$["EmailAddress"]''',
                                                    ).toString()}',
                                                  ...
                                                  child: RichText(
                                                    ...
                                                    text: TextSpan(
                                                      children: [
                                                        ...
                                                        TextSpan(
                                                          text:
                                                              'Payments received after 21:00 CST may not be credited to your account until the next day; your open-to-buy may not be updated for up to five (5) days.',
                                                          style: TextStyle(
                                                            color: FlutterFlowTheme
                                                                    .of(context)
                                                                .black,
