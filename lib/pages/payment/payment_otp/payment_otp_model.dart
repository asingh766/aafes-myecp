...
import 'payment_otp_widget.dart' show PaymentOtpWidget;
...
class PaymentOtpModel extends FlutterFlowModel<PaymentOtpWidget> {
  ...
  // Stores action output result for [Backend Call - API (Get Bank Accounts and Bank Profiles by User ID)] action in payment_otp widget.
  ApiCallResponse? apiResponseBanksAndBankProfiles;
  // Stores action output result for [Backend Call - API (Account Summary By Account Number)] action in payment_otp widget.
