...
import 'payment_otp_model.dart';
export 'payment_otp_model.dart';

class PaymentOtpWidget extends StatefulWidget {
  const PaymentOtpWidget({super.key});
                                                                            ...
                                                                            builder: (context) =>
                                                                              ...
                                                                              child: CommonCustomButtonWidget(
                                                                                ...
                                                                                onTap: () async {
                                                                                  ...
                                                                                  _model.apiResponseAddPayment = await PaymentsGroup.addPayamentCall.call(
                                                                                    userId: FFAppState().selectedUserId.toString(),
                                                                                    accountNo: getJsonField(
                                                                                      FFAppState().selectedPaymentAccount,
                                                                                      r'''$["AccountNumber"]''',
                                                                                  ...
                                                                                  if ((_model.apiResponseAddPayment?.succeeded ?? true)) {
                                                                                    ...
                                                                                    ScaffoldMessenger.of(context).showSnackBar(
                                                                                      SnackBar(
                                                                                        content: Text(
                                                                                          (_model.apiResponseAddPayment?.jsonBody ?? '').toString(),
                                                                                          style: TextStyle(
                                                                                            color: FlutterFlowTheme.of(context).primaryText,
                                                                                          ),
                                                                                        ),
