...
import 'custom_outlined_text_field_d_o_b_r_model.dart';
export 'custom_outlined_text_field_d_o_b_r_model.dart';

class CustomOutlinedTextFieldDOBRWidget extends StatefulWidget {
  const CustomOutlinedTextFieldDOBRWidget({
    super.key,
  ...
  @override
  State<CustomOutlinedTextFieldDOBRWidget> createState() =>
      _CustomOutlinedTextFieldDOBRWidgetState();
}

class _CustomOutlinedTextFieldDOBRWidgetState
    extends State<CustomOutlinedTextFieldDOBRWidget> {
  late CustomOutlinedTextFieldDOBRModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CustomOutlinedTextFieldDOBRModel());
