...
class BankingProfilesStruct extends BaseStruct {
  BankingProfilesStruct({
  ...
  static BankingProfilesStruct fromMap(Map<String, dynamic> data) =>
      BankingProfilesStruct(
  ...
  static BankingProfilesStruct? maybeFromMap(dynamic data) => data is Map
      ? BankingProfilesStruct.fromMap(data.cast<String, dynamic>())
      : null;
  ...
  static BankingProfilesStruct fromSerializableMap(Map<String, dynamic> data) =>
      BankingProfilesStruct(
  ...
  @override
  String toString() => 'BankingProfilesStruct(${toMap()})';

  @override
  bool operator ==(Object other) {
    const listEquality = ListEquality();
    return other is BankingProfilesStruct &&
...
BankingProfilesStruct createBankingProfilesStruct({
  String? productTypeDesc,
  bool? isPrimaryUser,
  String? accountNoLast4,
  String? accountNumber,
