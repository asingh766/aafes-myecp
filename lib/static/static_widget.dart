...
import 'static_model.dart';
export 'static_model.dart';
...
class _StaticWidgetState extends State<StaticWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => StaticModel());
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      setState(() {
        FFAppState().selelctedHeaderIndex = valueOrDefault<int>(
          widget.id,
          0,
        );
        FFAppState().selectedSubHeaderItem = widget.pageName!;
      });
      _model.apiResult39r = await StaticContentGroup.staticPagesCall.call(
        pageName: widget.pageName,
        dynamicBaseURL: FFAppState().dynamicBaseURL,
      );
      if ((_model.apiResult39r?.succeeded ?? true)) {
        setState(() {
          _model.content = (_model.apiResult39r?.bodyText ?? '');
        });
      }
