...
import 'custom_outlined_text_f_m_c_auth_code_model.dart';
export 'custom_outlined_text_f_m_c_auth_code_model.dart';

class CustomOutlinedTextFMCAuthCodeWidget extends StatefulWidget {
  const CustomOutlinedTextFMCAuthCodeWidget({
    super.key,
  ...
  @override
  State<CustomOutlinedTextFMCAuthCodeWidget> createState() =>
      _CustomOutlinedTextFMCAuthCodeWidgetState();
}

class _CustomOutlinedTextFMCAuthCodeWidgetState
    extends State<CustomOutlinedTextFMCAuthCodeWidget> {
  late CustomOutlinedTextFMCAuthCodeModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CustomOutlinedTextFMCAuthCodeModel());
