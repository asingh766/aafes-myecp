...
import 'custom_outlined_text_f_general_m_c_model.dart';
export 'custom_outlined_text_f_general_m_c_model.dart';

class CustomOutlinedTextFGeneralMCWidget extends StatefulWidget {
  const CustomOutlinedTextFGeneralMCWidget({
    super.key,
  ...
  @override
  State<CustomOutlinedTextFGeneralMCWidget> createState() =>
      _CustomOutlinedTextFGeneralMCWidgetState();
}

class _CustomOutlinedTextFGeneralMCWidgetState
    extends State<CustomOutlinedTextFGeneralMCWidget> {
  late CustomOutlinedTextFGeneralMCModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CustomOutlinedTextFGeneralMCModel());
